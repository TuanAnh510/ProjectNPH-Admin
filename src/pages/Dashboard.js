...
const Dashboard = () => {
  ...
  // console.log('bestSellerProductChart', bestSellerProductChart)
  return (
    <>
      ...
      <div className="grid gap-4 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <CardItem
          title={t("OrderTransit")}
          Icon={FiTruck}
          loading={loadingOrderCount}
          quantity={dashboardOrderCount?.totalTransitOrder || 0}
      ...
      <div className="grid gap-4 md:grid-cols-4 xl:grid-cols-4">
        ...
        <CardItemTwo
          mode={mode}
          currency={currency}
          title={t("YesterdayOrder")}
          title2={t("YesterdayOrder")}
          Icon={ImStack}
