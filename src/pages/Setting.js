              ...
              <div className="lg:px-6 pt-4 lg:pl-40 lg:pr-40 md:pl-5 md:pr-5 flex-grow scrollbar-hide w-full max-h-full pb-0">
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    <InputAreaTwo
                      register={register}
                      label={t("GlobalContactNumber")}
                      name="contact"
                      type="text"
                      placeholder={t("GlobalContactNumber")}
                    />
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    ...
                    />
                    <Error errorName={errors.facebooklink} pos />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    ...
                    />
                    <Error errorName={errors.instagramlink} pos />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className=" sm:col-span-3">
                    ...
                    />
                    <Error errorName={errors.youtubelink} pos />
                  </div>
                </div>
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                  ...
                  <div className=" sm:col-span-3">
                    <UploaderQR
                      ...
                      folder="qrmomo"
                    />
                    <Error errorName={errors.imageQR} pos />
                  </div>
                </div>
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
