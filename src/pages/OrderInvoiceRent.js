...
import InvoiceRent from "components/invoice/InvoiceRent";
import Loading from "components/preloader/Loading";
import PageTitle from "components/Typography/PageTitle";
import SettingServices from "services/SettingServices";
import { useTranslation } from "react-i18next";
import InvoiceForDownloadRent from "components/invoice/InvoiceForDownloadRent";

const OrderInvoiceRent = () => {
              ...
              <Table>
                <TableHeader>
                  <tr>
                    ...
                    <TableCell className="text-center">{t("Month")}</TableCell>
...
export default OrderInvoiceRent;
