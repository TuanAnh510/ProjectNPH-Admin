          ...
          {tapValue === t("BasicInfo") && (
            <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div className="col-span-8 sm:col-span-4">
                  <EditorTitleShip
                    titleShip={description}
                    setTitleShip={setDescription}
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label={t("SalePriceDrawwer")} />
                <div className="col-span-8 sm:col-span-4">
                  <InputValue
                    register={register}
                    ...
                    name="originalPrice"
                    type="number"
                    placeholder={t("SalePriceDrawwer")}
                    defaultValue={0.0}
                    required="false"
                    product
                    currency={currency}
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label={t("ProductWarranty")} />
                <div className="col-span-8 sm:col-span-4">
                  <Input
                    {...register(`warranty`, {
                    ...
                    type="text"
                    defaultValue={slug}
                    placeholder={t("ProductWarranty")}
                  />
                  <Error errorName={errors.warranty} />
                </div>
              </div>
