...
const LineChart = ({ salesReport, title, currency }) => {
  ...
  const formatCurrency = (value) => {
    return activeButton.title === "Sales" ? value.toLocaleString('vi-VN', { style: 'currency', currency: currency }) : value;
  };
        ...
        y: {
          ...
          ticks: {
            callback: function (value, index, values) {
              return Number.isInteger(value) ? formatCurrency(value) : '';
            },
          },
        },
      },
