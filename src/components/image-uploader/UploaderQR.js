...
const UploaderQR = ({
      ...
      files.forEach((file) => {
        ...
        axios({
          ...
          .then((res) => {
            ...
            setLoading(false);
            if (qrmomo) {
              setImageQR((imgUrl) => [...imgUrl, res.data.secure_url]);
            } else {
              setImageQR(res.data.secure_url);
            }
          })
          .catch((err) => {
  ...
  const handleRemoveImage = async (img) => {
    try {
      ...
      if (qrmomo) {
        const result = imageQR?.filter((i) => i !== img);
        setImageQR(result);
      } else {
        setImageQR("");
      }
        ...
        {qrmomo ? (
          ...
          <div className="relative">
            ...
            <button
              ...
              onClick={() => handleRemoveImage(imageQR)}
            >
              <FiXCircle />
            </button>
          </div>
