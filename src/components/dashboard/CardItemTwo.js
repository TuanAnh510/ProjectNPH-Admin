                ...
                <div className="text-center xl:mb-0 mb-3">
                  ...
                  <div className="flex text-center text-xs font-normal">
                    <div className="px-1 mt-3">
                      {t("Cash")} :  {" "}
                      {Intl.NumberFormat("vi-VN", { style: "currency", currency: currency }).format(Number(cash))}
                    </div>
                    <div className="px-1 mt-3">
                      {t("Card")} : {" "}
                      {Intl.NumberFormat("vi-VN", { style: "currency", currency: currency }).format(Number(card))}
                    </div>
                    {/* <div className="px-1 mt-3">
                      {t("Credit")} : {" "}
                      {Intl.NumberFormat("vi-VN", { style: "currency", currency: currency }).format(Number(credit))}
