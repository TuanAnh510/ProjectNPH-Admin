...
const ProductServices = {
  ...
  deleteRatingProduct: async (productId, ratingId) => {
    return requests.delete(
      `products/delete-rating?productId=${productId}&ratingId=${ratingId}`
    );
  },

  updateRent: async (id, body) => {
    return requests.put(`/products/rent/${id}`, body);
  },
};
